...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/curifactory-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/curifactory-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add curifactory
# for installing globally
pixi global install curifactory
```
...
It is possible to list all of the versions of `curifactory` available on your platform:
...
```
pixi search curifactory --channel conda-forge
```
